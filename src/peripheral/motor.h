 ...
 * これにより，割り込み関数{@code ISR(TIMER2_OVF_vect)}は、約13msec周期(約76.3Hz)で呼びだされます．
 * ただし、{@code set_t2intr_callback}で登録した関数はmotor.cで定義された回数に1回だけ呼ばれます。
 */
